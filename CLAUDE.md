...
3. **Prisma client import path.** The app imports PrismaClient from `@/generated/prisma/client` (NOT `@prisma/client`). The generator is configured with `output = "../src/generated/prisma"`. If you change the generator config, you must also update `src/lib/prisma.ts` to match.
...
8. **Do not commit `src/generated/`.** This directory is in `.gitignore`. It is auto-generated by `prisma generate` during the build.
...
- **Database:** PostgreSQL via Prisma ORM (Prisma 6 with `prisma-client` generator)
...
src/
  ...
  lib/              — Shared utilities
    prisma.ts       — Prisma client singleton (imports from @/generated/prisma/client)
